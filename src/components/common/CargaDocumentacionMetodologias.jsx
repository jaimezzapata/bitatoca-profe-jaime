...
export default function CargaDocumentacionMetodologias() {
  ...
  return (
    <form onSubmit={handleCargar} className="w-full flex flex-col items-center gap-2">
      <span className="text-pink-700 font-semibold text-base mb-1">Cargar Documentación para Metodologías</span>
      <input
